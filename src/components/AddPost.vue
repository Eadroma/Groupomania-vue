<template>
    <v-container class="pouet">
        <v-form ref="form">
            <v-textarea required v-model="content" name="addPost" filled label="Say Hello world !" auto-grow
                value="Hello world !">
            </v-textarea>
            <v-file-input v-model="file"
                ...
                label="File input" filled prepend-icon="mdi-file-image-plus"></v-file-input>
            <div class="button-container">
                <v-btn color="#D06A6C" @click="reset" style="color: #fff;">
                    Reset
                </v-btn>
                <v-btn color="#78d06a" :loading="loading" class="mr-4" @click="validate" style="color: #fff;"
                    :disabled="content == ''">
                    Envoyer
                </v-btn>
